...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="Reinforcer Avatars Dashboard | Reinforcer Admin Dashboard Template"
        description="This is Reinforcer Avatars Dashboard page for Reinforcer - LLM-Powered OBM ABC Analysis Tool"
      />
