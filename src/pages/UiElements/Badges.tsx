...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="Reinforcer Badges Dashboard | Reinforcer Admin Dashboard Template"
        description="This is Reinforcer Badges Dashboard page for Reinforcer - LLM-Powered OBM ABC Analysis Tool"
      />
